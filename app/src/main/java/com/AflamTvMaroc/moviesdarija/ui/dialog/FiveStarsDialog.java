...
public class FiveStarsDialog implements DialogInterface.OnClickListener {
    ...
    private void build() {
        ...
        dialogView = inflater.inflate(R.layout.rate_stars, null);
...
//        if (!disabled) {
        build();
        alertDialog.show();
        alertDialog.getButton(android.app.AlertDialog.BUTTON_POSITIVE).setTextColor(context.getResources().getColor(android.R.color.black));
